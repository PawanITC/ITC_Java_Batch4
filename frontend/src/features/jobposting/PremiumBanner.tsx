    ...
    <div className="bg-white rounded-xl border-t-4 border-t-amber-500 border border-x-gray-200 border-b-gray-200 p-4">
      ...
      <div className="flex items-center gap-3 mt-4">
        <div className="flex -space-x-2 overflow-hidden">
          <img className="inline-block h-8 w-8 rounded-full ring-2 ring-white" src="https://via.placeholder.com/32/blue" alt="User 1" />
          <img className="inline-block h-8 w-8 rounded-full ring-2 ring-white" src="https://via.placeholder.com/32/gray" alt="User 2" />
        </div>
